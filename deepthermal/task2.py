...
from deepthermal.plotting import plot_model_history, plot_model_scatter, plot_result, plot_observables_scatter
...
SET_NAME = f"noML_1_{DATA_COLUMN}"
FOLDS = 5
#########
...
if __name__ == "__main__":
    ...
    plot_result(path_figures=PATH_FIGURES, plot_name=SET_NAME, **cv_results, plot_function=plot_model_scatter,
                function_kwargs=plot_kwargs)
    plot_result(path_figures=PATH_FIGURES, plot_name=SET_NAME+"_", **cv_results, plot_function=plot_observables_scatter,
                function_kwargs=plot_kwargs)
    # functions to make
